...
import com.zhouzhou.interceptor.FirstInterceptor;
 ...
 * @author 周万宁
 * @className WebConfig
 * @create 2023/1/3-3:48
 * @description 代替springmvc的配置文件
 *
 * 扫描组件,视图解析器,默认的servlet处理静态资源,mvc注解驱动,视图控制器,文件上传解析器,拦截器,异常解析器
 *
 */

@Configuration
//扫描组件的注解
@ComponentScan("com.zhouzhou.controller")
//开启mvc的注解驱动
@EnableWebMvc
